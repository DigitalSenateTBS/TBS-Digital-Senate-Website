    ...
    <div class="learn-more">
	  <div class="container">
		<div class="row">
			...
			<p><a href="<?php echo config::url() ?>/news.php">News</a></p>
		  </div>
		  <div class="col-md-4">
			<h3>The Digital Senate</h3>
			<p>Learn more about the digital uprising here at TBS!</p>
			<p><a href="<?php echo config::url() ?>/digital_senate.php">Digital Senate</a></p>
	      </div>
		  <div class="col-md-4">
              <h3>Contacts</h3>
			<p>Find teacher`s emails!</p>
			<p><a href="<?php echo config::url() ?>/contact_us.php">See More</a></p>
		  </div>
	    </div>
	  </div>
	</div>
